...
const Footer = () => {
    return (
        <div>
            <footer className="text-white border-t lg:grid lg:grid-cols-5">
                <div className="relative block h-32 lg:col-span-2 lg:h-full">
                    <img
                        src="/footer.jpg"
                        alt=""
                        className="border-r absolute inset-0 h-full w-full object-cover"
                    />
                </div>
                ...
                <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                <span className="text-xs uppercase tracking-wide text-white"> Contact Number </span>
